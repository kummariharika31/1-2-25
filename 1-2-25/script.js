let products = [
    ...
    },
    {
        ...
        "price": 599,
        "description": "21. 5 inches Full HD (1920 x 1080) widescreen IPS display And Radeon free Sync technology. No compatibility for VESA Mount Refresh Rate.",
        "category": "electronics",
...
products.forEach(obj => {
    ...
    `
    item2.innerHTML = `
    <img src= "${obj.image}" alt="asdf" />
    <p><b>Rating<b/><p/>
    <p><b>Rate</b> :${obj.rating.rate}</p>
